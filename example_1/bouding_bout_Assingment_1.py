...
# เซ็ตค่าคงที่การเคลื่อนที่
TILE_LEN = 0.587  # ความยาวกระเบื้อง 0,6(เมตร) แต่ปรับเป็น 0.587 เพื่อให้หุ่นยนต์เดินได้เต็มกระเบื้อง
TURN_ANGLE = -91.5  # มุมการหมุน  90 (องศา) # ปรับมุมเลี้ยวให้มากขึ้นเพื่อให้หุ่นยนต์หมุนได้เต็มที
...
# เซ็ตค่าคงที่เซ็นเซอร์           
SENSOR_FREQ = 5  # ความถี่การรับข้อมูลเซ็นเซอร์ (Hz) (เซ็ตไว้เป็น 5 ครั้งต่อวินาที)    
OUTPUT_DIR = r"csv_3"  # โฟลเดอร์เก็บข้อมูลเซ็นเซอร์
...
position_records = []  # รายการเก็บข้อมูลตำแหน่ง
attitude_records = []  # รายการเก็บข้อมูลมุมทิศทาง
imu_records = []  # รายการเก็บข้อมูล IMU
esc_records = []  # รายการเก็บข้อมูล ESC
status_records = []  # รายการเก็บข้อมูลสถานะ
